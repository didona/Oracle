...
public abstract class CubistOracle implements Oracle {
   ...
   protected final static boolean t = log.isTraceEnabled();
   ...
   private void loadModel() throws OracleException {
      ...
      if (t) log.trace("Loading model " + builtModel);
